#ifndef SETTINGS_UI_H_
#define SETTINGS_UI_H_
 ...
 */
void lv_settings_create(lv_obj_t *root, lv_settings_page_t *pages, uint8_t num_pages, lv_group_t *input_group,
